...
const { antiToxic, antiTraba, antiviewonce, isBanned, welcome, detect, sWelcome, sRules, sBye, sPromote, sDemote, antiLink, antiLink2, modohorny, autosticker, audios, delete: del } = global.db.data.chats[m.chat]
